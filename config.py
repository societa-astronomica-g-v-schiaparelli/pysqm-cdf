...
_observatory_name = 'SCHIAP'
_observatory_latitude  = 45.86889
_observatory_longitude = 8.77083
_observatory_altitude  = 1226
...
_device_locationname = 'Varese/Italy - Osservatorio Schiaparelli'         # Device location in the world
...
'''
full_plot = False
limits_nsb = [16.5,22.0] # Limits in Y-axis
